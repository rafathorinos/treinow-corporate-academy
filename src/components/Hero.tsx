...
const Hero = () => {
  return <section className="min-h-screen relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-black">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-32 right-20 w-32 h-32 bg-primary/30 rounded-full blur-2xl animate-float-elegant" style={{
        animationDelay: '2s'
      }}></div>
        <div className="absolute top-1/2 left-1/3 w-24 h-24 bg-primary/15 rounded-full blur-xl animate-float-elegant" style={{
        animationDelay: '4s'
      }}></div>
      </div>
      ...
      <div className="container mx-auto px-4 pt-28 pb-20 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Main headline */}
          <div className="text-center mb-16 animate-slide-up-elegant" style={{
          animationDelay: '0.3s'
        }}>
          ...
          <div className="max-w-6xl mx-auto mb-16 animate-fade-in-luxury" style={{
          animationDelay: '0.6s'
        }}>
            <div className="glass-ultra rounded-3xl p-8 md:p-12 hover-float">
              <div className="video-container-luxury aspect-video relative">
                <iframe src="https://www.linkedin.com/embed/feed/update/urn:li:ugcPost:7335771083968602112?compact=1&autoplay=1&muted=1" className="w-full h-full rounded-2xl relative z-10" frameBorder="0" allowFullScreen title="Treinow - Demonstração da Plataforma" allow="autoplay; fullscreen" />
              ...
              <div className="mt-10 text-center">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  ...
                  icon: CheckCircle,
                  text: "48h Setup",
                  desc: "Implementação ultrarrápida"
                }, {
                  icon: Sparkles,
                  text: "100% Digital",
                  desc: "Processo completamente automatizado"
                }].map((feature, index) => <div key={index} className="glass-card rounded-xl p-6 hover-glow">
          ...
          <div className="text-center animate-slide-up-elegant" style={{
          animationDelay: '0.9s'
        }}>
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
              <Button size="lg" className="btn-luxury text-white font-bold px-12 py-6 text-xl rounded-full">
                Solicitar Demonstração Exclusiva
                <ArrowRight className="ml-3 w-6 h-6" />
              </Button>
              
              <Button variant="outline" size="lg" className="btn-outline-luxury text-white font-bold px-12 py-6 text-xl rounded-full">
